...
import {GRWidget} from "../../widgets/GRWidget.js";
// @ts-ignore
...
export class ProjectTab extends WidgetBasedTabContext {
    ...
    constructor(name: string, tabManager: TabManager) {
    ...
    loadAllProjects(): void {
        ...
        const addNewTabCallback = (context: TabContext) => {
            this.tabManager.addTabContext(context);
            this.tabManager.setActiveTab(context);
        };
        const deleteSelfCallback = (widget: GRWidget) => {
